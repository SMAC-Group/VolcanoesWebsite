...
Manages the right sidebar panel that displays information about selected points: individual point details (all column values) and selection statistics (count, mean, std dev for numeric columns).
